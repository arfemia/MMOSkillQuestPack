...
Requires the MMO Skill Tree mod (1.6.1+) and the ZiggfreedCommon library it already runs on (2.1.0+). The pack supplies the content; the mod and its library supply the quest, dialogue, NPC and boss-fight engines.
...
1. Install the MMO Skill Tree mod (1.6.1 or newer) and its ZiggfreedCommon library (2.1.0 or newer).
